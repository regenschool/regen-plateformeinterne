-- Fonction pour synchroniser automatiquement le statut de complétion et visibilité d'une épreuve
...
-- Trigger sur INSERT/UPDATE/DELETE de grades
DROP TRIGGER IF EXISTS trigger_sync_assessment_completion ON grades;
CREATE TRIGGER trigger_sync_assessment_completion
AFTER INSERT OR UPDATE OR DELETE ON grades
FOR EACH ROW
EXECUTE FUNCTION sync_assessment_completion();