...
-- Les vues doivent utiliser les permissions de l'utilisateur qui les interroge

-- Recréer la vue des étudiants enrichis sans SECURITY DEFINER
...
-- Recréer la vue des notes enrichies sans SECURITY DEFINER
