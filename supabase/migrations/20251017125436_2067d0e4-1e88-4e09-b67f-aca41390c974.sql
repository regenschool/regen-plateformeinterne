-- ============================================================================
-- CORRECTION SÉCURITÉ: Vue sans SECURITY DEFINER
-- PostgreSQL ne supporte pas SECURITY INVOKER dans CREATE VIEW
-- On utilise security_invoker = true dans les options
-- ============================================================================
