...
test('Debug login step by step', async ({ page }) => {
  ...
  // Étape 3: Vérifier le mode (signup vs login)
  ...
  // Étape 5: Cliquer sur submit et observer
  ...
  // Capturer tout le contenu de la page
